...
@Slf4j
@RestController
// @RequestMapping("/api/auth/kakao") // 통합 OAuthController 사용을 위해 주석 처리
@RequiredArgsConstructor
@Tag(name = "Kakao 인증 (Deprecated)", description = "새로운 OAuthController를 사용하세요")
public class KakaoAuthController {
    ...
    //     
    //     // 3. 사용자 조회 또는 생성
    //     User user = customOAuth2UserService.processKakaoUser(oAuth2UserInfo, request);
    //     
