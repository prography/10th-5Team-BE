...
@Slf4j
@RestController
// @RequestMapping("/api/auth/naver") // 통합 OAuthController 사용을 위해 주석 처리
@RequiredArgsConstructor
@Tag(name = "Naver 인증 (Deprecated)", description = "새로운 OAuthController를 사용하세요")
public class NaverAuthController {
    ...
    //     
    //     // 3. 사용자 조회 또는 생성
    //     User user = customOAuth2UserService.processNaverUser(oAuth2UserInfo, request);
    //     
